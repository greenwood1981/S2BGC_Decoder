...
BGC_Decoder: src/.objectfiles/main.o src/.objectfiles/write_json.o src/.objectfiles/write_list.o src/.objectfiles/message.o src/.objectfiles/profile.o src/.objectfiles/pump.o src/.objectfiles/rise.o src/.objectfiles/fall.o src/.objectfiles/gps.o src/.objectfiles/bist.o src/.objectfiles/Engineering_Data.o src/.objectfiles/BIT.o src/.objectfiles/argo.o
	g++ -g -std=c++17 $(OFILES) -o BGC_Decoder

$(OBJ)/main.o: src/main.cpp src/output/write_log.h src/.objectfiles/hexfile.o src/.objectfiles/log.o
	g++ -g -std=c++17 -c src/main.cpp -lboost_filesystem -o $@

$(OBJ)/write_list.o: src/output/write_list.cpp
	g++ -g -std=c++17 -c src/output/write_list.cpp -o $@

$(OBJ)/write_json.o: src/output/write_json.cpp
	g++ -g -std=c++17 -c src/output/write_json.cpp -o $@

$(OBJ)/write_log.o: src/output/write_log.cpp
	g++ -g -std=c++17 -c src/output/write_log.cpp -o $@
...
$(OBJ)/fall.o: src/pressure_time_series/fall.cpp src/pressure_time_series/fall.h src/pressure_time_series/pressure_time_series.h
	g++ -g -std=c++17 -c src/pressure_time_series/fall.cpp -o $@
